  ...
  return (
    <><>
          <header>
              ...
              <div className="guide">
                <h2>ルール説明</h2>
                <p>最初にオプションから好きな関数を選ぼう。すると、選んだ関数の説明が現れ、その下に処理が1行ずつ表示されるため、右の欄に正しい順で並べて回答しよう。右の欄では、ひとつ上（または下）に移動、一番上（または下）に移動するボタンで選択した処理を並び替えることができる。また、処理を複数選択することができ、UNCHECKボタンですべての選択を解除することができる。回答する際は、ANSWERボタンを押そう。回答が正しいかどうかは上に表示される。何度も回答できるため正解するまで挑戦してみよう。</p>
              </div>
          </header>
